...
const core = (0, tslib_1.__importStar)(__webpack_require__(186));
const fs = (0, tslib_1.__importStar)(__webpack_require__(747));
const axios_1 = (0, tslib_1.__importDefault)(__webpack_require__(545));
const path_1 = (0, tslib_1.__importDefault)(__webpack_require__(622));
...
function getInputValue(key) {
    if (!key || key === null || key === '') {
        ...
        if (!val || val === null || val === '') {
            core.setFailed(`Attempted to read input for key ${key} but value was null or empty`);
            return null;
        }
        else {
