...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const latestRun = yield getWorkflowRunByRunId(githubClient, workflow, runId);
